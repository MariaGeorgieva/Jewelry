        ...
        <div class="list-group">
            ...
            <div class="list-group">
                <a class="list-group-item list-group-item-action "
                   href="{{route('home')}}"
                ><i class="material-icons">home</i>&ensp;home page</a>

                <a class="list-group-item list-group-item-action"
                   href="{{url('/upload')}}"
                ><i class="material-icons">file_upload</i>&ensp;upload product</a>

                <a class="list-group-item list-group-item-action"
                   href="{{ url('/show') }}"><i
                            class="material-icons">slideshow</i>&ensp;show products</a>
                <a class="list-group-item list-group-item-action"
                ...
                {{--><i class="material-icons">card_giftcard</i>&ensp;edit special offers</a>--}}
                {{--<a class="list-group-item list-group-item-action " href="#home"--}}
                {{--><i class="material-icons">extension</i>&ensp;create section</a>--}}
            </div>
        </div>
    </div>
</div>